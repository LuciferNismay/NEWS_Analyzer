...
# --- CONFIGURATION ---
st.set_page_config(page_title="NewsFlow: AI Editor", layout="wide", page_icon="🗞️")
...
def analyze_and_generate(article, model_name):
    ...
    OUTPUT FORMAT:
    Return ONLY valid JSON with these keys: "category", "sentiment", "truth_score", "fact_check_reason", "blog_draft", "social_draft".
    """
        ...
        if data:
            ...
            with st.form("editor_form"):
                ...
                with col_right:
                    ...
                    st.markdown("**⚙️ Publishing Options**")
